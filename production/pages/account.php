<div id=UploadDiv class="container">
    ...
    <div id="change_pass" class="panel panel-default">
        <div class="panel-body">
            Current Password: <input id="cur_pass" type="password"> New Password: <input id="new_pass" type="password"> New Password Confirm: <input id="new_pass_conf" type="password">
