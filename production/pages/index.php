        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 text-center">
                    ...
                    <svg class="threeColPics" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <section id="MapMission">
        <div class="container" id="mapContainer">
            <div class="container" id="missionContainer">
                <h1 id="missionStatement">A safer world, starting from your dashcam.<h1>
            </div>
        ...
        <div class="container" id="Hours">
            <h1 id="hoursStatement">343,228 hours of footage collected.<h1>
        </div>
    </section>
    <aside class="bg-dark">
